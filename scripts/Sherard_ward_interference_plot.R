...
r<-c(-r,4,r) %>% sort()
Qs<-c(226*192.5,1200*192.5) # first ward, then sherard
...
Ward$r<-Ward$r-670
Ward$Well<-"Bill Ward No. 2"
Sherard$Well<-"Sherard No. 6"
...
p<-ggplot(plotme, aes(x=r,y=-s, shape=Well)) + geom_point() + geom_line(aes(color=Well)) +
  ...
  labs(subtitle=paste0("Bill Ward No. 2 pumping at 2017-2021 average annual production rate, Sherard No. 6 at 60% of adjudicated flow rate"),
